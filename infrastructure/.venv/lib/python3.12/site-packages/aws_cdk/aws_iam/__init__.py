...
class GroupProps:
    ...
    def path(self) -> typing.Optional[builtins.str]:
        ...
        Identifiers <https://docs.aws.amazon.com/IAM/latest/UserGuide/index.html?Using_Identifiers.html>`_
