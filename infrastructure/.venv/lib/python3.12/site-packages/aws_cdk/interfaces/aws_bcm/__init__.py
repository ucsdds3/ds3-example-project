...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_bcm.DashboardReference",
    jsii_struct_bases=[],
...
class DashboardReference:
    def __init__(self, *, dashboard_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e1b039c6c3e2d8f8b98787a58253cb3f88d8932e939e00d3de68164384df1099)
...
@jsii.interface(jsii_type="aws-cdk-lib.interfaces.aws_bcm.IDashboardRef")
class IDashboardRef(
...
class _IDashboardRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_bcm.IDashboardRef"
...
def _typecheckingstub__e1b039c6c3e2d8f8b98787a58253cb3f88d8932e939e00d3de68164384df1099(
    *,
