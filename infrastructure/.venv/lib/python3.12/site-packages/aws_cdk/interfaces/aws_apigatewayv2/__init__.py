...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"api_id": "apiId", "stage_name": "stageName"},
)
class StageReference:
    def __init__(self, *, api_id: builtins.str, stage_name: builtins.str) -> None:
        '''A reference to a Stage resource.

        :param api_id: The ApiId of the Stage resource.
