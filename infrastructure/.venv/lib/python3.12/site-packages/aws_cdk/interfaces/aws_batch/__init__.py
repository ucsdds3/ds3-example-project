...
@jsii.interface(jsii_type="aws-cdk-lib.interfaces.aws_batch.IQuotaShareRef")
class IQuotaShareRef(
    _constructs_77d1e7e8.IConstruct,
    _IEnvironmentAware_f39049ee,
    typing_extensions.Protocol,
):
    '''(experimental) Indicates that this resource can be referenced as a QuotaShare.
    ...
    def quota_share_ref(self) -> "QuotaShareReference":
        '''(experimental) A reference to a QuotaShare resource.
...
class _IQuotaShareRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_batch.IQuotaShareRef"
    ...
    def quota_share_ref(self) -> "QuotaShareReference":
        ...
        :stability: experimental
        '''
        return typing.cast("QuotaShareReference", jsii.get(self, "quotaShareRef"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IQuotaShareRef).__jsii_proxy_class__ = lambda : _IQuotaShareRefProxy
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_batch.QuotaShareReference",
    jsii_struct_bases=[],
    name_mapping={"quota_share_arn": "quotaShareArn"},
)
class QuotaShareReference:
    def __init__(self, *, quota_share_arn: builtins.str) -> None:
        '''A reference to a QuotaShare resource.

        :param quota_share_arn: The QuotaShareArn of the QuotaShare resource.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7f296255df633634241d5f4948791adc26c7ea017fededc933d5a45a02eb3dd9)
            check_type(argname="argument quota_share_arn", value=quota_share_arn, expected_type=type_hints["quota_share_arn"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "quota_share_arn": quota_share_arn,
        }

    @builtins.property
    def quota_share_arn(self) -> builtins.str:
        '''The QuotaShareArn of the QuotaShare resource.'''
        result = self._values.get("quota_share_arn")
        assert result is not None, "Required property 'quota_share_arn' is missing"
        return typing.cast(builtins.str, result)
    ...
    def __repr__(self) -> str:
        return "QuotaShareReference(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
def _typecheckingstub__7f296255df633634241d5f4948791adc26c7ea017fededc933d5a45a02eb3dd9(
    *,
    quota_share_arn: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
for cls in [IComputeEnvironmentRef, IConsumableResourceRef, IJobDefinitionRef, IJobQueueRef, IQuotaShareRef, ISchedulingPolicyRef, IServiceEnvironmentRef]:
