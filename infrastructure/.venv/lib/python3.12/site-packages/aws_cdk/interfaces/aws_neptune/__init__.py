...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_neptune.GlobalClusterReference",
    jsii_struct_bases=[],
...
class GlobalClusterReference:
    def __init__(self, *, global_cluster_identifier: builtins.str) -> None:
        ...
        Example::
            ...
            global_cluster_reference = interfaces_neptune.GlobalClusterReference(
...
class _IGlobalClusterRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_neptune.IGlobalClusterRef"
...
def _typecheckingstub__65835ecd6e4955d67d79ec864fe925d5b96ad56aec3f7c939ad81399531d23b8(
    *,
...
for cls in [IDBClusterParameterGroupRef, IDBClusterRef, IDBInstanceRef, IDBParameterGroupRef, IDBSubnetGroupRef, IEventSubscriptionRef, IGlobalClusterRef]:
