...
@jsii.interface(
    jsii_type="aws-cdk-lib.interfaces.aws_observabilityadmin.ITelemetryEnrichmentRef"
)
class ITelemetryEnrichmentRef(
    ...
    def telemetry_enrichment_ref(self) -> "TelemetryEnrichmentReference":
        '''(experimental) A reference to a TelemetryEnrichment resource.
...
class _ITelemetryEnrichmentRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_observabilityadmin.ITelemetryEnrichmentRef"
    ...
    def telemetry_enrichment_ref(self) -> "TelemetryEnrichmentReference":
        ...
        :stability: experimental
        '''
        return typing.cast("TelemetryEnrichmentReference", jsii.get(self, "telemetryEnrichmentRef"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITelemetryEnrichmentRef).__jsii_proxy_class__ = lambda : _ITelemetryEnrichmentRefProxy
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_observabilityadmin.TelemetryEnrichmentReference",
    jsii_struct_bases=[],
    name_mapping={"scope": "scope"},
)
class TelemetryEnrichmentReference:
    def __init__(self, *, scope: builtins.str) -> None:
        '''A reference to a TelemetryEnrichment resource.

        :param scope: The Scope of the TelemetryEnrichment resource.
        ...
        Example::
            ...
            telemetry_enrichment_reference = interfaces_observabilityadmin.TelemetryEnrichmentReference(
                scope="scope"
            )
        '''
        if __debug__:
    ...
    def __repr__(self) -> str:
        return "TelemetryEnrichmentReference(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
def _typecheckingstub__78dbfd0ff77f71dfa376f007a7542930424c0b9eb4a24480bf27bd80463ce6a3(
    *,
    scope: builtins.str,
) -> None:
    """Type checking stubs"""
...
for cls in [IOrganizationCentralizationRuleRef, IOrganizationTelemetryRuleRef, IS3TableIntegrationRef, ITelemetryEnrichmentRef, ITelemetryPipelinesRef, ITelemetryRuleRef]:
