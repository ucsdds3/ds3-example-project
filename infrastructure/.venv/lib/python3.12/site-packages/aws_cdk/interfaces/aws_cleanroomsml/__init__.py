...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_cleanroomsml.ConfiguredModelAlgorithmAssociationReference",
    jsii_struct_bases=[],
    name_mapping={
...
class ConfiguredModelAlgorithmAssociationReference:
    def __init__(
        self,
        *,
        configured_model_algorithm_association_arn: builtins.str,
    ) -> None:
        '''A reference to a ConfiguredModelAlgorithmAssociation resource.

        :param configured_model_algorithm_association_arn: The ConfiguredModelAlgorithmAssociationArn of the ConfiguredModelAlgorithmAssociation resource.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c67966da22754716f0f9aa1f060506aef456c654648cc335612c655a0b436fe8)
            check_type(argname="argument configured_model_algorithm_association_arn", value=configured_model_algorithm_association_arn, expected_type=type_hints["configured_model_algorithm_association_arn"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "configured_model_algorithm_association_arn": configured_model_algorithm_association_arn,
        }

    @builtins.property
    def configured_model_algorithm_association_arn(self) -> builtins.str:
        '''The ConfiguredModelAlgorithmAssociationArn of the ConfiguredModelAlgorithmAssociation resource.'''
        result = self._values.get("configured_model_algorithm_association_arn")
        assert result is not None, "Required property 'configured_model_algorithm_association_arn' is missing"
    ...
    def __repr__(self) -> str:
        return "ConfiguredModelAlgorithmAssociationReference(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_cleanroomsml.ConfiguredModelAlgorithmReference",
    jsii_struct_bases=[],
    name_mapping={"configured_model_algorithm_arn": "configuredModelAlgorithmArn"},
)
class ConfiguredModelAlgorithmReference:
    def __init__(self, *, configured_model_algorithm_arn: builtins.str) -> None:
        '''A reference to a ConfiguredModelAlgorithm resource.

        :param configured_model_algorithm_arn: The ConfiguredModelAlgorithmArn of the ConfiguredModelAlgorithm resource.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__eb4c9d651b129c3508fd0d411b20c60cc3610451f8356aad6a8fc2911636d2d7)
    ...
    def __repr__(self) -> str:
        return "ConfiguredModelAlgorithmReference(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.interface(
    jsii_type="aws-cdk-lib.interfaces.aws_cleanroomsml.IConfiguredModelAlgorithmAssociationRef"
)
class IConfiguredModelAlgorithmAssociationRef(
...
class _IConfiguredModelAlgorithmAssociationRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_cleanroomsml.IConfiguredModelAlgorithmAssociationRef"
    ...
    def configured_model_algorithm_association_ref(
        ...
        :stability: experimental
        '''
        return typing.cast("ConfiguredModelAlgorithmAssociationReference", jsii.get(self, "configuredModelAlgorithmAssociationRef"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IConfiguredModelAlgorithmAssociationRef).__jsii_proxy_class__ = lambda : _IConfiguredModelAlgorithmAssociationRefProxy


@jsii.interface(
    jsii_type="aws-cdk-lib.interfaces.aws_cleanroomsml.IConfiguredModelAlgorithmRef"
)
class IConfiguredModelAlgorithmRef(
    _constructs_77d1e7e8.IConstruct,
    _IEnvironmentAware_f39049ee,
    typing_extensions.Protocol,
):
    '''(experimental) Indicates that this resource can be referenced as a ConfiguredModelAlgorithm.
    ...
    def configured_model_algorithm_ref(self) -> "ConfiguredModelAlgorithmReference":
        '''(experimental) A reference to a ConfiguredModelAlgorithm resource.
...
class _IConfiguredModelAlgorithmRefProxy(
    jsii.proxy_for(_constructs_77d1e7e8.IConstruct), # type: ignore[misc]
    jsii.proxy_for(_IEnvironmentAware_f39049ee), # type: ignore[misc]
):
    '''(experimental) Indicates that this resource can be referenced as a ConfiguredModelAlgorithm.
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_cleanroomsml.IConfiguredModelAlgorithmRef"
    ...
    def configured_model_algorithm_ref(self) -> "ConfiguredModelAlgorithmReference":
        ...
        :stability: experimental
        '''
        return typing.cast("ConfiguredModelAlgorithmReference", jsii.get(self, "configuredModelAlgorithmRef"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IConfiguredModelAlgorithmRef).__jsii_proxy_class__ = lambda : _IConfiguredModelAlgorithmRefProxy
...
def _typecheckingstub__c67966da22754716f0f9aa1f060506aef456c654648cc335612c655a0b436fe8(
    *,
    configured_model_algorithm_association_arn: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__eb4c9d651b129c3508fd0d411b20c60cc3610451f8356aad6a8fc2911636d2d7(
    *,
...
for cls in [IConfiguredModelAlgorithmAssociationRef, IConfiguredModelAlgorithmRef, ITrainingDatasetRef]:
