...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_interconnect.ConnectionReference",
    jsii_struct_bases=[],
...
class ConnectionReference:
    def __init__(self, *, connection_arn: builtins.str) -> None:
        ...
        Example::
            ...
            from aws_cdk.interfaces import aws_interconnect as interfaces_interconnect
            
            connection_reference = interfaces_interconnect.ConnectionReference(
                connection_arn="connectionArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__73e494ead6ff30c0b2ea134755badbb2523ae2cc18a5b89645a85ea9c2b9dd14)
...
@jsii.interface(jsii_type="aws-cdk-lib.interfaces.aws_interconnect.IConnectionRef")
...
class _IConnectionRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_interconnect.IConnectionRef"
...
def _typecheckingstub__73e494ead6ff30c0b2ea134755badbb2523ae2cc18a5b89645a85ea9c2b9dd14(
    *,
